...
while true; do
    ...
    if [ $level1_selection -eq 5 ]; then
        ...
        while true; do
            # Level 2 (Set Up)
            setup_options=("React App" "Vite App" "Express Server")
        ...
        while true; do
            # Level 2 (Remove)
            remove_options=("React App" "Vite App" "Express Server")
        ...
        while true; do
            # Level 2 (Remove)
            reload_options=("React App" "Vite App" "Express Server")
        ...
        while true; do
            ...
            view_options=("React App" "Vite App" "Express Server")
